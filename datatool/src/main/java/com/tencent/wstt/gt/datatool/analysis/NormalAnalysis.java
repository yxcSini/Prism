        ...
        if (lastNormalInfo != null) {
            ...
            if (isFront(lastNormalInfo.time) && isFront(normalInfo.time)) {
                ...
                if (frontTime >= 0 //时间需要正向
                    ...
                    frontBackInfo.frontCpuArray.add((float)frontCpuApp * 100L / frontCpuTotal);
                    frontBackInfo.frontMemoryArray.add((float)frontMemory);
            ...
            if (!isFront(lastNormalInfo.time) && !isFront(normalInfo.time)) {
                ...
                if (backTime >= 0 //时间需要正向
                    ...
                    frontBackInfo.backCpuArray.add((float)backCpuApp * 100L / backCpuTotal);
                    frontBackInfo.backMemoryArray.add((float)backMemory);
