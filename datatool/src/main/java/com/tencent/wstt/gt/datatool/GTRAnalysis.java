...
import com.tencent.wstt.gt.datatool.analysis.prism.PrismFragmentAnalysis;
...
public class GTRAnalysis {
    ...
    PrismFragmentAnalysis fragmentAnalysis = new PrismFragmentAnalysis(this, fragmentInfos, overFragments);
    //基础数据：
