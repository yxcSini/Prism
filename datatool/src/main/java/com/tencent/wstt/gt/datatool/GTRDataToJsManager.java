...
/**
 * <br> ClassName:   GTRDataToJsManager
 * <br> Description:
 * <br>
 * <br> Author:      yexiaochuan
 * <br> Date:        2018/5/30 15:40
 */
public class GTRDataToJsManager {
    private static final int BUFFER_SIZE = 1 << 20;

    public static final String resultDataFilePath = FileUtil.SDCardPathHelper.GTR_DATAJS_PATH_NAME;
    public static final String getResultDataFilePath = FileUtil.SDCardPathHelper.GTR_WX_DATAJS_PATH_NAME;
     ...
     * @param dataDirPath    目标文件目录
     * @return
     * @throws Exception
     */
    public static Boolean toAnalysis(String dataDirPath) throws Exception {
