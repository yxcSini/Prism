...
public class FrontBackInfo {
    ...
    public ArrayList<Float> frontCpuArray = new ArrayList<>();
    public ArrayList<Float> frontMemoryArray = new ArrayList<>();
    ...
    public ArrayList<Float> backCpuArray = new ArrayList<>();
    public ArrayList<Float> backMemoryArray = new ArrayList<>();
